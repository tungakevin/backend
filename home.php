...
<nav class="navbar navbar-expand-lg navbar-light bg-danger" style="height:8vh;">
    <div class="container-fluid ml-2">
       <div>
            <a class="navbar-brand text-white" href="#"> PHP Assignment</a>
       </div>
        <div class="d-flex justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <img src="images/tunga.jpeg" class="rounded-circle" alt="profile of client" width="40" height="40" srcset="">
                </a>
  ...
  <!--we start to designer every things on home page -->
<div class="body mx-0"  style="min-height:83vh;">
    <div class="row mx-0 mt-1">
        <div class="col-md-8 md-sm-12 m-0">
        <div class="mt-0 bg-dark" style="background-image:url(images/download.jpeg);min-height:20vh;">
                <div class="profile">
                    <div class="py-3">&nbsp;</div>
                    <strong class="text-white"style="position:absolute">
<img src="images/mine.jpg" class="rounded-circle mx-3" alt="profile image" width="90" height="100" srcset="">
                    TUNGA Kevin</strong>
            ...
            <div class="headline mt-3 position-relative border-primary border-top border-1">
                ...
                <p><b>volunteer | SOCIAL AFFAIR</b></p>
            </div>
