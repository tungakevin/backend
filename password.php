...
<div class="sign-in round">
    <div class="card shadow text-center">
        ...
        <strong>Congratulation , Tunga kevin</strong>
        </div>
        <form action="" method="post" class="px-3">
            
            <div class="d-flexjustify-content-center">
                <span class="w-75 py-1 px-4 border-primay border" style="border-primary border:50px 50px 50px 50px ">
                    <i class="fa fa-user text-primary i"></i>
                    <span>uwingabekevin5@gmail.com</span>
                </span>
            </div>
