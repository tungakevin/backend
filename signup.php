        ...
        <form action="controller/signup.php" method="post" class="px-3">
            ...
            <div class="container my-1">
                ...
                <div>
                    ...
                    <div style="margin-top:-1.9rem"><span style="background:white; z-index:1;">OR</span></div>
                </div>
                <button id="my-signin2" class="btn text-center form-control border-0 "></button>
                <span href="#" class="btn text-center form-control text-danger border-0"> arleady have an account  <a href="#" class="text-center">sign in</a></span>
